function handles = addtabCL( parent, handles )
%ADDTABCL Builds the UI for the CL grid analysis
...
handles.axesCL = axes('Parent', axesPanel);
axis square

frameControlVBox = uix.VBox( 'Parent', vBoxLeft, 'Padding', 10, 'Spacing', 5 , ...
    'BackgroundColor', 'b');
handles.sliderCL = uicontrol('Parent', frameControlVBox, ...
    'BackgroundColor', [.9 .9 .9], ...
    'Style', 'Slider', ...
    'Callback', @onSlideCLMove);
...
handles.localizerCL = localizerPanel;
